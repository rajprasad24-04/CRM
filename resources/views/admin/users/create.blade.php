...
<head>
    ...
    <title>Wealixir | Create User</title>
    ...
    <div class="left-content">
        <div class="inner-content">
            ...
            <div class="outter-wp container-fluid">
                <section class="users-form-hero">
                    <div class="users-form-hero__text">
                        <div class="users-form-hero__badge">
                            <i class="fa fa-user-plus"></i>
                            Admin Console
                        </div>
                        <h3>Create User</h3>
                        <p>Create a new workspace login and configure role-based permissions.</p>
                    </div>
                    <div class="users-form-hero__crumbs">
                        <ol class="breadcrumb">
                ...
                <section class="users-form-panel">
                    <div class="users-form-panel__head">
                        <div class="users-form-panel__title">
                            <i class="fa fa-user-plus"></i>
                            New Login
                        </div>
                        <div class="users-form-panel__sub">Provide account details and access configuration</div>
                    </div>

                    <div class="users-form-panel__body">
                        @if ($errors->any())
