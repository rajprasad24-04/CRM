    ...
    <div class="left-content">
        <div class="inner-content">
            ...
            <div class="outter-wp">
                ...
                <h2>Edit Password for {{ $client->client_name }}</h2>
                    ...
                    <div class="graph-form">
                        <div class="form-body">
<!-- resources/views/client_passwords/edit.blade.php -->


<form action="{{ route('client_passwords.update', [$client->id, $password->id]) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="form-group">
    <label for="title">Title</label>
    <input class="form-control" type="text" name="title" id="title" value="{{ $password->title }}" required>
    </div>
    <div class="form-group">
    <label for="user_id">User ID</label>
    <input class="form-control" type="text" name="user_id" id="user_id" value="{{ $password->user_id }}" required>
</div>
    <div class="form-group">
    ...
    <textarea class="form-control" name="notes" id="notes">{{ $password->notes }}</textarea>
    </div>
